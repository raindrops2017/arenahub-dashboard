...
export default function CustomersPage() {
  ...
  const [notifyCustomer, setNotifyCustomer] = useState<CustomerUser | null>(null);

  const handleOpenNotifyModal = (customer: CustomerUser) => {
  ...
  const handleStatusUpdated = (updated: Partial<CustomerUser>) => {
  ...
  return (
    <>
                      ...
                      <tr key={cId} className="hover:bg-gray-50/60 dark:hover:bg-gray-800/40 transition">
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex items-center justify-end gap-1.5">
                            ...
                            <button
                              onClick={() => handleOpenNotifyModal(customer)}
                              className="px-2.5 py-1 text-xs font-semibold rounded-lg bg-red-50 text-red-600 hover:bg-red-100 dark:bg-red-950/40 dark:text-red-400 transition"
                              title="Send In-App & Push Notification to this Customer"
                            >
                              🔔 Notify
                            </button>
                            <button
      ...
      {/* Direct Customer Notification Modal */}
